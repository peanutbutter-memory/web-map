...
if DEPLOY_STATUS == "Production":
    ...
    tilemap_path = "/app/WEB/blob/assets/sites/west-coast-high-resolution/burrand_inlet/tiles/{z}/{x}/{y}.png" #app.get_asset_url("sites/west-coast-high-resolution/burrand_inlet/tiles/{z}/{x}/{y}.png")
